...
/**
 * @brief   Verify if ListResponse is properly (de)serialized with minimal sequence number
...
/**
 * @brief   Verify if ListResponse is properly (de)serialized with minimal + 1 sequence number
 * @test    Expected result:
...
/**
 * @brief   Verify if ListResponse is properly (de)serialized with minimal + 2 sequence number
 * @test    Expected result:
...
/**
 * @brief   Verify if ListResponse is properly (de)serialized with medium sequence number
 * @test    Expected result:
...
/**
 * @brief   Verify if ListResponse is properly (de)serialized with maximum - 2 sequence number
 * @test    Expected result:
...
/**
 * @brief   Verify if ListResponse is properly (de)serialized with maximum sequence number
 * @test    Expected result:
