...
bool operator==(const timespec &t1, const timespec &t2) {
    ...
    EXPECT_EQ(t1.tv_nsec, t2.tv_nsec);
    return true;
}

namespace Cynara {
bool operator==(const MonitorEntry &m1, const MonitorEntry &m2) {
...
const int64_t TV_NSEC_MAX = std::numeric_limits<decltype(get_member_type(&timespec::tv_nsec))>::max();
