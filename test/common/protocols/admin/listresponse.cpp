...
TEST(ProtocolAdmin, ListResponse03) {
    std::vector<Policy> policies = {
        Policy(Keys::k_3, Results::bucket_1),
    };
...
TEST(ProtocolAdmin, ListResponse05) {
    std::vector<Policy> policies = {
        Policy(Keys::k_5, Results::plugin_1),
    };
...
TEST(ProtocolAdmin, ListResponse06) {
    std::vector<Policy> policies = {
        Policy(Keys::k_6, Results::plugin_2),
    };
...
TEST(ProtocolAdmin, ListResponse07) {
    std::vector<Policy> policies = {
        Policy(Keys::k_7, Results::plugin_3),
    };
...
TEST(ProtocolAdmin, ListResponseMultiplePolicies) {
    std::vector<Policy> policies = {
        ...
        Policy(Keys::k_2, Results::deny),
        Policy(Keys::k_3, Results::bucket_1),
        Policy(Keys::k_4, Results::bucket_2),
        Policy(Keys::k_5, Results::none),
        Policy(Keys::k_6, Results::plugin_3),
        Policy(Keys::k_7, Results::plugin_4),
    };
