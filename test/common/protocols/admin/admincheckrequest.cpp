...
static const bool NOT_RECURSIVE = false;
...
TEST(ProtocolAdmin, AdminCheckRequest01) {
    auto request = std::make_shared<AdminCheckRequest>(Keys::k_1, Buckets::empty, RECURSIVE,
                                                       SN::min);
...
TEST(ProtocolAdmin, AdminCheckRequest02) {
    auto request = std::make_shared<AdminCheckRequest>(Keys::k_2, Buckets::b_1, NOT_RECURSIVE,
                                                       SN::min_1);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}
...
TEST(ProtocolAdmin, AdminCheckRequest03) {
    auto request = std::make_shared<AdminCheckRequest>(Keys::k_3, Buckets::b_2, RECURSIVE,
                                                       SN::min_2);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}
...
TEST(ProtocolAdmin, AdminCheckRequest04) {
    auto request = std::make_shared<AdminCheckRequest>(Keys::k_4, Buckets::empty, NOT_RECURSIVE,
                                                       SN::max);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}
...
TEST(ProtocolAdmin, AdminCheckRequest05) {
    auto request = std::make_shared<AdminCheckRequest>(Keys::k_5, Buckets::b_1, RECURSIVE,
                                                       SN::max_1);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}
...
TEST(ProtocolAdmin, AdminCheckRequest06) {
    auto request = std::make_shared<AdminCheckRequest>(Keys::k_6, Buckets::b_2, NOT_RECURSIVE,
                                                       SN::max_2);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}
...
TEST(ProtocolAdmin, AdminCheckRequest07) {
    auto request = std::make_shared<AdminCheckRequest>(Keys::k_7, Buckets::empty, RECURSIVE,
                                                       SN::mid);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}
