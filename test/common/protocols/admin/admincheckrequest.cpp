...
TEST(ProtocolAdmin, AdminCheckRequest03) {
    auto request = std::make_shared<AdminCheckRequest>(Keys::k_www, Buckets::empty, NOT_RECURSIVE,
                                                       SN::min_2);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}
...
TEST(ProtocolAdmin, AdminCheckRequest07) {
    auto request = std::make_shared<AdminCheckRequest>(Keys::k_nua, Buckets::empty, NOT_RECURSIVE,
                                                       SN::mid);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}
