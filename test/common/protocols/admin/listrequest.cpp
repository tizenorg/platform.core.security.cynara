...
TEST(ProtocolAdmin, ListRequest01) {
    auto request = std::make_shared<ListRequest>(Buckets::empty, Keys::k_1, SN::min);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}

TEST(ProtocolAdmin, ListRequest02) {
    auto request = std::make_shared<ListRequest>(Buckets::b_1, Keys::k_2, SN::min_1);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}

TEST(ProtocolAdmin, ListRequest03) {
    auto request = std::make_shared<ListRequest>(Buckets::b_2, Keys::k_3, SN::min_2);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}

TEST(ProtocolAdmin, ListRequest04) {
    auto request = std::make_shared<ListRequest>(Buckets::empty, Keys::k_4, SN::max);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}

TEST(ProtocolAdmin, ListRequest05) {
    auto request = std::make_shared<ListRequest>(Buckets::b_1, Keys::k_5, SN::max_1);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}

TEST(ProtocolAdmin, ListRequest06) {
    auto request = std::make_shared<ListRequest>(Buckets::b_2, Keys::k_6, SN::max_2);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}

TEST(ProtocolAdmin, ListRequest07) {
    auto request = std::make_shared<ListRequest>(Buckets::empty, Keys::k_7, SN::mid);
    auto protocol = std::make_shared<ProtocolAdmin>();
    testRequest(request, protocol);
}
