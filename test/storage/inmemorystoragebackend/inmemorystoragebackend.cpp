 ...
 * @test    Scenario:
 * - Sample database is loaded from earlier prepared Cynara's policy database directory (db7)
 ...
 * Possible solution: copy CYNARA_TESTS_DIR/db7 to /tmp/db7 and initialize backend with /tmp path
 */
