...
mkdir -p %{buildroot}/usr/lib/cynara/plugin/service
mkdir -p %{buildroot}/usr/lib/cynara/plugin/client
...
%{_libdir}/cynara/service/libservice-plugin.so
%{_libdir}/cynara/client/libclient-plugin.so
