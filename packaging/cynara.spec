...
Helper credentials socket library

%package -n libcynara-helper-socket-credentials-devel
Summary:    Helper credentials socket library (devel)
...
Helper credentials dbus library

%package -n libcynara-helper-dbus-credentials-devel
Summary:    Helper credentials sdbus library (devel)
Requires:   libcynara-helper-dbus-credentials = %{version}-%{release}
...
%defattr(-,root,root,-)
%license LICENSE
%{_libdir}/libcynara-helper-socket-credentials.*

%files -n libcynara-helper-socket-credentials-devel
%defattr(-,root,root,-)
%{_includedir}/cynara/cynara-socket-credentials-helper.h
%{_libdir}/pkgconfig/cynara-helper-socket-credentials.pc
%{_libdir}/libcynara-helper-socket-credentials.so

%files -n libcynara-helper-dbus-credentials
%manifest libcynara-helper-dbus-credentials.manifest
%defattr(-,root,root,-)
%license LICENSE
%{_libdir}/libcynara-helper-dbus-credentials.*

%files -n libcynara-helper-dbus-credentials-devel
%defattr(-,root,root,-)
%{_includedir}/cynara/cynara-dbus-credentials-helper.h
%{_libdir}/pkgconfig/cynara-helper-dbus-credentials.pc
%{_libdir}/libcynara-helper-dbus-credentials.so
