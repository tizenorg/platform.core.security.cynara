...
cp LICENSE %{buildroot}/usr/share/license/libcynara-client
cp LICENSE %{buildroot}/usr/share/license/libcynara-admin
%make_install
...
%files -n cynara
%manifest %{_datadir}/cynara.manifest
...
%manifest %{_datadir}/libcynara-client.manifest
%defattr(-,root,root,-)
%{_libdir}/libcynara-client.so.*
%{_datadir}/license/libcynara-client

%files -n libcynara-client-devel
%defattr(-,root,root,-)
%{_libdir}/libcynara-client.so
%{_libdir}/libcynara-commons.so.*
/usr/include/cynara/cynara-client.h
%{_libdir}/pkgconfig/*.pc

%files -n libcynara-admin
%manifest %{_datadir}/libcynara-admin.manifest
%defattr(-,root,root,-)
%{_libdir}/libcynara-admin.so.*
%{_datadir}/license/libcynara-admin

%files -n libcynara-admin-devel
%defattr(-,root,root,-)
%{_libdir}/libcynara-admin.so
%{_libdir}/libcynara-commons.so.*
/usr/include/cynara/cynara-admin.h
%{_libdir}/pkgconfig/*.pc
