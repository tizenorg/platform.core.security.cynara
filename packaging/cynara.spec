...
if [ $1 -gt 1 ] ; then
    ...
    %{_sbindir}/cynara/cynara-db-migration.sh upgrade ${OLDVERSION} %{version}
else
    %{_sbindir}/cynara/cynara-db-migration.sh install 0 %{version}
fi
...
%postun
if [ $1 = 0 ]; then
    %{_sbindir}/cynara/cynara-db-migration.sh uninstall %{version} 0
