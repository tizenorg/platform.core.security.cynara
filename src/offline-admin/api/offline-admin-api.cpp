 ...
 */
/**
 * @file        src/storage/api/offline-admin-api.cpp
...
#include <offline-admin/api/ApiInterface.h>
...
int cynara_offline_admin_set_policies(struct cynara_offline_admin *p_cynara_offline_admin,
    ...
    return p_cynara_offline_admin->impl->setPolicies(insertOrUpdate, remove);
}
...
int cynara_offline_admin_set_bucket(struct cynara_offline_admin *p_cynara_offline_admin,
    ...
    auto logic = p_cynara_offline_admin->impl;
