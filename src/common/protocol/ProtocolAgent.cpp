...
void ProtocolAgent::serializeResponseToBuffer(AgentActionResponse &response,
                                              BinaryQueue &bufferQueue) {
    ...
    ProtocolFrameSerializer::finishSerialization(frame, bufferQueue);
}
