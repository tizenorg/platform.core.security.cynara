...
PolicyResult::PolicyResult(const PolicyType &policyType)
    : m_type(policyType)
{}
...
const PolicyType& PolicyResult::policyType() const {
    return m_type;
}

const PolicyResult::PolicyMetadata& PolicyResult::metadata() const {
    return m_metadata;
}
