 ...
 */
/*
 * @file        CancelRequest.h
 * @author      Marcin Niesluchowski <m.niesluchow@samsung.com>
 * @version     1.0
 * @brief       This file declares cancel request class
 */
...
private:
    ProtocolFrameSequenceNumber m_checkId;

public:
    CancelRequest(const ProtocolFrameSequenceNumber checkId,
                  ProtocolFrameSequenceNumber sequenceNumber)
        : Request(sequenceNumber), m_checkId(checkId) {}
