 ...
 * @version     1.0
 * @brief       This file contains definition of Logic class - main
...
public:
    ...
    virtual int check(const std::string &client, const std::string &session,
                      ...
                      unsigned int &checkId) noexcept;
    virtual int receive(unsigned int &checkId) noexcept;
    virtual int cancel(const unsigned int checkId) noexcept;
};
