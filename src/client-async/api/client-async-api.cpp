                            ...
                            void *user_status_data)
{
    ...
    try {
        *pp_cynara = new cynara_async(new Cynara::Logic(callback,
                                                        user_status_data));
...
CYNARA_API
int cynara_async_check_cache(cynara_async *p_cynara,
                             const char *client,
                             ...
                             const char *privilege)
{
    ...
    return p_cynara->impl->checkCache(client,
                                      client_session,
                                      user,
                                      privilege);
}
                                ...
                                void *user_response_data)
{
    ...
    return p_cynara->impl->createRequest(client,
                                         client_session,
                                         user,
                                         privilege,
                                         *p_check_id,
...
CYNARA_API
int cynara_async_cancel_request(cynara_async *p_cynara,
