...
public:
    ...
    virtual int checkCache(const std::string &client, const std::string &session,
                           const std::string &user, const std::string &privilege) noexcept = 0;
    virtual int createRequest(const std::string &client, const std::string &session,
                              ...
                              void *userResponseData) noexcept = 0;
    virtual int process(void) noexcept = 0;
    virtual int cancelRequest(cynara_check_id checkId) noexcept = 0;
};
