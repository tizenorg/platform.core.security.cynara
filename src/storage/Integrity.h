...
protected:
    static void syncElement(const std::string &filename, int flags = O_RDONLY, mode_t mode = 0600);
    static void syncDirectory(const std::string &dirname, mode_t mode = 0600);
