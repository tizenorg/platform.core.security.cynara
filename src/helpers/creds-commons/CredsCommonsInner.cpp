...
// returns true when key and value FOUND, false when no more lines with key and values
...
static inline int interpretKeyAndValue(const CredentialsMap &methodCodeMap, const char *methodName,
                                       int &method, std::string &key,std::string &value,
                                       bool &occurred) {
