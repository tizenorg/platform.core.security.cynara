...
public:
    ...
    /*
     * Check if enought entries are stored for given client.
     */
     ...
     * storedt, they will not be accessible for new client)
     */
    void addClient(RequestContext::ClientId clientId, uint16_t bufferSize);
    /*
     * Modify client buffer size.
     */
    void modifyClient(RequestContext::ClientId, uint16_t bufferSize);
    /*
