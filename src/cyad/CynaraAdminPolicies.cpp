...
void CynaraAdminPolicies::add(const PolicyBucketId &bucketId, const PolicyType &policyType,
                              ...
                              const PolicyKey &policyKey)
{
    ...
    policy->result_extra = metadata.empty() ? nullptr : strdup(metadata.c_str());
