...
namespace CyadCmdlineArgs {
    ...
    const char *ADD_BUCKET_LONG = "add-bucket";

    const char DELETE_BUCKET = 'c';
    const char *DELETE_BUCKET_LONG = "delete-bucket";

    const char POLICY = 'p';
    const char *POLICY_LONG = "policy";

    const char METADATA = 'm';
    const char *METADATA_LONG = "metadata";
}

namespace CyadCmdlineErrors {
    const char *UNKNOWN_ERROR = "Unknown error";
    const char *NO_OPTION = "No option specified";
    const char *UNKNOWN_OPTION = "Unknown option";
    const char *UNKNOWN_OPTION_ADD_BUCKET = "Unknown option in --add-bucket";
    const char *UNKNOWN_OPTION_DELETE_BUCKET = "Unknown option in --delete-bucket";
    const char *NO_POLICY = "No --policy specified";
    const char *NO_BUCKET = "No bucket specified";
    const char *INVALID_POLICY = "Invalid --policy option";
}
