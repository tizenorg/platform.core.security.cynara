...
const OptionsMap commandlineOptions = {
    ...
    { CmdlineOpt::Erase,
        { "erase", CmdlineOpt::Erase, "erase=<name>",
          "name of bucket to erase policies from - required", OptHasArg::RequiredArgument } },
    { CmdlineOpt::Check,
        { "check", CmdlineOpt::Check, "check",
          "", OptHasArg::NoArgument } },
    { CmdlineOpt::ListPolicies,
        { "list-policies", CmdlineOpt::ListPolicies, "list-policies=<bucket>",
          "name of bucket to list policies from - required", OptHasArg::RequiredArgument } },
    ...
    { CmdlineOpt::Type,
        { "type", CmdlineOpt::Type, "type=<type>",
          "policy type - required", OptHasArg::RequiredArgument } },
    { CmdlineOpt::Metadata,
    ...
    { CmdlineOpt::Client,
        { "client", CmdlineOpt::Client, "client=<client>",
          "client value - required", OptHasArg::RequiredArgument } },
    { CmdlineOpt::User,
        { "user", CmdlineOpt::User, "user=<user>",
          "user value - required", OptHasArg::RequiredArgument } },
    { CmdlineOpt::Privilege,
        { "privilege", CmdlineOpt::Privilege, "privilege=<privilege>",
          "privilege value - required", OptHasArg::RequiredArgument } },
    ...
    { CmdlineOpt::Recursive,
        { "recursive", CmdlineOpt::Recursive, "recursive=<yes|no>",
          "if linked buckets should be processed as well - required", OptHasArg::RequiredArgument } },
