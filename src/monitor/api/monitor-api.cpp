...
struct cynara_monitor_entry {
    ...
    friend const char *cynara_monitor_entry_get_client(const cynara_monitor_entry *);
    friend const char *cynara_monitor_entry_get_user(const cynara_monitor_entry *);
    friend const char *cynara_monitor_entry_get_privilege(const cynara_monitor_entry *);
    friend int cynara_monitor_entry_get_result(const cynara_monitor_entry *);
    friend const struct timespec *cynara_monitor_entry_get_timestamp(const cynara_monitor_entry *);

    cynara_monitor_entry(const Cynara::MonitorEntry &monitorEntry)
...
int cynara_monitor_configuration_create(cynara_monitor_configuration **pp_conf) {
    ...
    return Cynara::tryCatch([&]() {
        ...
        *pp_conf = new cynara_monitor_configuration(ptr.release());
...
int cynara_monitor_initialize(cynara_monitor **pp_cynara_monitor,
    ...
    return Cynara::tryCatch([&]() {
        ...
        *pp_cynara_monitor = new cynara_monitor(ptr.release());
