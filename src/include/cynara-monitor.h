...
/**
 * \brief Returns all monitor entries.
 *
 * \par Description:
 *
 * Returns all available monitor entries.
 *
 * \par Purpose:
 * This API should be used to list all available monitor entries.
 *
 * \par Typical use case:
 ...
 *
 * If there are no monitor entries to be returned, the function block until there are any.
 * \endparblock
 *
 * \par Sync (or) Async:
 * This is a synchronous API.
 ...
 * \return CYNARA_API_SUCCESS on success, or error code otherwise.
 */
int cynara_monitor_entries_free(cynara_monitor *p_cynara_monitor,
                                cynara_monitor_entry **monitor_entries);
