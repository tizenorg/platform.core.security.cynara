 ...
 * cynara_async_create_simple_request() and will be triggered exactly once in 4 kind of situations:
 ...
 *
 * \par Important notes:
 * Call to cynara_async_create_simple_request() needs cynara_async structure to be created first with
 * cynara_async_initialize().
 * Call cynara_async_cancel_request() to cancel pending request.
