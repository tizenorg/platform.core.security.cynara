 ...
 * still some pending checks, cynara_async_receive MUST be called after this call as long as
 * answer not ready is returned. If service does not get answer after this calls, it may get
 * it asynchronously by calling cynara_async_receive.
 *
 * \par Method of function operation:
 ...
 * on access denial, CYNARA_ASYNC_API_ANSWER_NOT_READY on answer receive asynchronously
 ...
 * called until answer not ready has been received. After that answer can be received by this call
 * if a read event occurs on socket received by cynara_async_connect.
 *
 * \par Method of function operation:
