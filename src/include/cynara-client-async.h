 ...
 *            Number is valid since cynara_async_cancel_request() call till callback call.
 ...
 *
 * \par Typical use case:
 * When cynara_async_check() returned CYNARA_API_CACHE_MISS, so cynara service has to be asked,
 * if a client requesting access to some privilege has proper rights. To receive matching response
 ...
 * When function is succesfully called unique check_id id returned. It is used for matching
 ...
 * cynara_async_initialize() before calling this function.
