...
/*! \brief   indicating that provided buffer is to short */
 ...
 * Moreover, the user must not invoke setlocale() concurrently with this function as results
 * of such a deed are unspecified and no refunds for killed hamsters or kittens are offered.
 *
