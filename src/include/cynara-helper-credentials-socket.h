 ...
 */
/*
 * @file        cynara-helper-credentials-socket.h
...
#ifndef CYNARA_HELPER_CREDENTIAL_SOCKET_H
#define CYNARA_HELPER_CREDENTIAL_SOCKET_H
 ...
 */
int cynara_helper_credentials_socket_get_client(int socket_fd, enum cynara_client_creds method,
                                                char **client);
 ...
 *         CYNARA_API_OUT_OF_MEMORY when there was error allocating memory
 */
int cynara_helper_credentials_socket_get_user(int socket_fd, enum cynara_user_creds method,
                                              char **user);
...
#endif /* CYNARA_HELPER_CREDENTIAL_SOCKET_H */
