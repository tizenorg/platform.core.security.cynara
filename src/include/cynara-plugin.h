...
extern "C" {
typedef ExternalPlugin *(*createPlugin)(void);
}
...
public:
     ...
     */
    virtual PolicyTypes getSupportedPolicyType(void) = 0;
     ...
     * @param[out] result      Response interpreted from agen
