 ...
 * function.
 * Returned string is used as client parameter in cynara_check() or cynara_async_create_request()
 * function.
 ...
 * The function is called before the call of cynara_check() or cynara_async_create_request()
 * function.
 * Returned string is used as user parameter in cynara_check() or cynara_async_create_request()
 * function.
 * String is released with free() function when it is no longer needed.
 *
 * \par Method of function operation:
