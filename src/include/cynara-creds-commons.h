 ...
 * The function might be called by cynara_creds_dbus_get_client()
 * and cynara_creds_socket_get_client().
 *
 ...
 *
 * \par Typical use case:
 * The function might be called by cynara_creds_dbus_get_user()
 * and cynara_creds_socket_get_user().
 *
 * \par Method of function operation:
