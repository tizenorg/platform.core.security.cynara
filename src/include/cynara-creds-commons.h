 ...
 * Now the function is mockuped. It sets method to CLIENT_METHOD_SMACK and returns CYNARA_API_SUCCESS.
 ...
 * Now the function is mockuped. It sets method to USER_METHOD_UID and returns CYNARA_API_SUCCESS.
